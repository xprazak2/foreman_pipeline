module ForemanPipeline
  class Job < Katello::Model
    ...
    attr_accessible :name, :content_view_id, :hostgroup_id, :organization_id, :compute_resource_id, :jenkins_instance_id,
      :environment_id, :manual_trigger, :levelup_trigger, :sync_trigger, :organization, :hostgroup, :compute_resource,
      :content_view, :jenkins_instance, :environment, :to_environments
